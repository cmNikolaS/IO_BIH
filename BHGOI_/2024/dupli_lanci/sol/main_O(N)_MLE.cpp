// O(N), ali na poslednjem podzadatku će doći do MLE (Memory Limit Exceeded) zbog velikih vektora.
#include <iostream>
#include <vector>
#include <algorithm>
...
int main() {
	...
	if(n <= 20) {
		...
		vector<long long> dp(n+2, 0); // dp[i] je kumulativna suma od dp[0] do dp[i], predstavlja broj 
